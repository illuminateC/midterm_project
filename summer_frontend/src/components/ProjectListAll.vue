      ...
      <div style="width: 100%; flex-wrap: wrap; display: flex;">
        <div class="docment-container" v-for="table in tableData" style="display: inline-block;">
          <div class="document" @mouseover="hover = true" @mouseleave="hover = false">
            <div class="layer layer111" :class="{ hidden: !hover }">
              <div class="icon-row">
...
export default {
  ...
  methods: {
    ...
    handleFilterChange(filters) {
      ...
      const columnKey = 'el-table_1_column_4'; // Replace this with your actual columnKey
...
.document:hover .layer111 {
  visibility: visible;
}

.document:hover .layer222 {
  opacity: 0.3;
}
